...
const ReminderForm = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        await axios.post("http://localhost:3000/api/reminders/add", { phone, medication, time });
    ...
    return (
        <div className="p-20 bg-gray-900 text-white rounded-xl shadow-lg border border-gray-700 max-w-md mx-auto">
            <h2 className="text-2xl font-bold mb-4 text-cyan-400 text-center">Set Medication Reminder</h2>
